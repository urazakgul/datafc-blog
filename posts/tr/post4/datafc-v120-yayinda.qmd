...
Yeni sürümde `match_data` veri setine skorlarla ilgili önemli eklemeler yapıldı. Bu güncellemeler, veri analizi süreçlerini daha detaylı hale getirerek skor verilerine daha hızlı erişim sağlamak için tasarlandı.
